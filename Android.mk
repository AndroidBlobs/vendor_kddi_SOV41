...
ifeq ($(TARGET_DEVICE),SOV41)

include $(CLEAR_VARS)
LOCAL_MODULE := libsdm-disp-apis
LOCAL_MODULE_OWNER := kddi
...
include $(CLEAR_VARS)
LOCAL_MODULE := com.sonymobile.simlock.platform
LOCAL_MODULE_OWNER := kddi
LOCAL_SRC_FILES := proprietary/vendor/framework/com.sonymobile.simlock.platform.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
...
include $(CLEAR_VARS)
LOCAL_MODULE := com.sonymobile.simlock.platform_impl
LOCAL_MODULE_OWNER := kddi
LOCAL_SRC_FILES := proprietary/vendor/framework/com.sonymobile.simlock.platform_impl.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
